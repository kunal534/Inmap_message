...
export class NotificationService {
  ...
  async sendSlackNotification(email: EmailNotification): Promise<void> {
  ...
  async triggerExternalWebhook(email: EmailNotification): Promise<void> {
  ...
  async notifyInterestedEmail(email: EmailNotification): Promise<void> {
